...
async function _deployCollection() {
  ...
  await hre.run("verify:verify", { address: "0x1D2f85e3778C51A8b6419b0818bAb18fa9668915" });
}
...
async function _createCollection(FactoryProxyAddress: any, sender: any) {
  ...
  const ogs = ["0x37aa961D37F3513ae760ea7B704dAe3415f67B2F", "0x985Ec7d924Fc4e18ab99C2c7F1Bb83f7898cA146", "0x2ff9cb5A21981e8196b09AD651470b41Ba28b9C6"]
  const wls = ["0x37aa961D37F3513ae760ea7B704dAe3415f67B2F", "0x985Ec7d924Fc4e18ab99C2c7F1Bb83f7898cA146", "0x2ff9cb5A21981e8196b09AD651470b41Ba28b9C6"]
...
const FACTORY_PROXY_GOERLI = "0x0f1eD4c89494fd16933fEA9518D9018f4a7EFb9e";
const FACTORY_PROXY_MUMBAI = "0xAB6d34d6a3b7395462a1fa40ffF556B69f63c875";

const CLONE_IMPL_GOERLI = "0x852d88D30CC00009248B29a2b5325204F4242Aa3";
const CLONE_IMPL_MUMBAI = "0x1D2f85e3778C51A8b6419b0818bAb18fa9668915";
...
async function main() {
  ...
  // _initFactory(FACTORY_PROXY_MUMBAI, CLONE_IMPL_MUMBAI);

  // _updateMember(FACTORY_PROXY_GOERLI,GHALEB_MEMBER_2,0,0);// platformFee, discount
  _updateMember(FACTORY_PROXY_MUMBAI,MEMBER_2,0,0);// platformFee, discount


  // _createCollection(FACTORY_PROXY_GOERLI, MEMBER_2);
  _createCollection(FACTORY_PROXY_MUMBAI, MEMBER_2);


  // _updatePartnership(FACTORY_PROXY_GOERLI,CLONE_721A,MEMBER_2);
  // _grantRole(CLONE_721A,"OG",MEMBER_2,REFERRAL);

  // _mint(CLONE_721A,"OWNER",MEMBER_2,MEMBER_2,1,300000000000000n) // (CloneAddress, stage,sender,to,amount,payment) {
