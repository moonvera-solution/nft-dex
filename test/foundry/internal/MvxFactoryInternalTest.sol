...
contract MvxFactoryInternalsTest is MvxFactory, Test{
    ...
    function test_fuzz_applyDiscount(
        ...
        Artist memory artistObj = Artist({
            referral: referral.addr,
            referralBalance:0,
        ...
        uint256 _deployFeeAfterDiscounts = deployFee - _percent(deployFee, partnerObj.discount);
        
        partners[artistObj.collection] = partnerObj;
        super._applyDiscount(
            artistObj,
            sender,
            msgValue,
            deployFee
